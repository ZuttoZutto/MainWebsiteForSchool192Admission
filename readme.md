# Веб-сайт для приёма в школу №192
...
На рис. 1 показано, к каким страницам (а следовательно и функциям на страницах) имеют доступ пользователи с разными ролями.
## АРХИТЕКТУРА БАЗЫ ДАННЫХ САЙТА

На рис. 2 представлена схема таблиц базы данных.

## ОТЧЁТ О РАЗРАБОТКЕ ПРОЕКТА

Разработана архитектуры сайта и базы данных, подобраны инструменты для выполнения проекта, приведено в жизнь большинство функций для абитуриента и учителя. Большая часть функций администратора на данный момент не воплощены в коде.
